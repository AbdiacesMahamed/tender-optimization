...
#: Excel's day-serial epoch. Excel counts days from 1899-12-30 (its intentional
#: 1900-leap-year bug). A date cell delivered as a NUMBER (common from .xlsx)
#: arrives as a serial like 45658 == 2025-01-01.
