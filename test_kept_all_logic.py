...
trace_1, destinations_1 = trace_container_movements(current_data_1, origin_map_1)
result_1 = format_flip_details(trace_1[0], show_container_ids=False, container_destinations=destinations_1)
...
trace_2, destinations_2 = trace_container_movements(current_data_2, origin_map_2)
result_2 = format_flip_details(trace_2[0], show_container_ids=False, container_destinations=destinations_2)
...
trace_3, destinations_3 = trace_container_movements(current_data_3, origin_map_3)
result_3 = format_flip_details(trace_3[0], show_container_ids=False, container_destinations=destinations_3)
